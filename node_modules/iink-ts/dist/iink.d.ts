 ...
 */
type TIEditorTriggerConfiguration = {
 ...
 * @source
 */
declare const DefaultIEditorTriggerConfiguration: TIEditorTriggerConfiguration;
 ...
 * DEMAND :       Action is triggered on external demande
 */
type TIIEditorTriggerConfiguration = {
    exportContent: "QUIET_PERIOD" | "POINTER_UP" | "DEMAND";
    exportContentDelay: number;
    resizeTriggerDelay: number;
};
 ...
 * @source
 */
declare const DefaultIIEditorTriggerConfiguration: TIIEditorTriggerConfiguration;
